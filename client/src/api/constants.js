const BASE_URL = 'https://mighty-chamber-19968.herokuapp.com'; // https://glacial-everglades-16804.herokuapp.com';

export const AUTH_USER = BASE_URL.concat('/auth');
...
export const SEND_CLOTHING_ITEM_IMAGE_TEXT = BASE_URL.concat('/text');

export const UPLOAD_ITEM_IMAGE = BASE_URL.concat('/virtual/api/v1.0/upload');

export const AVATAR = BASE_URL.concat('/avatar');

export const RECOMMENDATIONS = BASE_URL.concat('/recommendation');
